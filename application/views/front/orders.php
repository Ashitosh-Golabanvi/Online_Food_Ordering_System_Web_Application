    ...
    <div class="container shadow-container">
        ...
        <div class="table-responsive-sm">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                <?php $conn = new mysqli('localhost', 'root', '', 'foodorderigniter');
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <!-- <td><?php 
                        $conn = new mysqli('localhost', 'root', '', 'foodorderigniter');
